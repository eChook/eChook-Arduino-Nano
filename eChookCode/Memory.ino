...
void saveCurrCalToEeprom() {
  ...
  setFloatCal(INDEX_INTERNAL_REFERENCE_VOLTAGE,
...
void loadEepromCalibration() {
  ...
  CAL_DATA_TRANSMIT_INTERVAL =
      (unsigned long)getFloatCal(INDEX_TRANSMIT_INTERVAL);
  ...
  CAL_INTERNAL_REFERENCE_VOLTAGE =
      getFloatCal(INDEX_INTERNAL_REFERENCE_VOLTAGE);
  ...
  if (CAL_INTERNAL_REFERENCE_VOLTAGE == 0 ||
      CAL_INTERNAL_REFERENCE_VOLTAGE == 0xFF) {
